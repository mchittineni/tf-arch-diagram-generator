        ...
        <div class="modal-dialog">
          <div class="modal-header">
            <h3 style="font-size:16px; font-weight:700; color:#fff; display:flex; align-items:center; gap:8px;">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#9a6ad4" stroke-width="2">
            ...
            <button id="btn-modal-close" class="control-btn">✕</button>
          </div>
          ...
          <div class="modal-body">
            ...
            <div id="import-dropzone" class="dropzone">
              <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#9a6ad4" stroke-width="2">
            ...
            <div>
              ...
              <textarea id="import-textarea" class="code-textarea" placeholder='{"format_version": "1.2", "resource_changes": [ ... ]}'></textarea>
            </div>

            <div id="import-error-msg" style="color:#ef4444; font-size:12px; display:none;"></div>
          </div>
